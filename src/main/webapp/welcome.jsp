...
<%
	...
	// getParameter 메소드이므로 앞으로의 입력 요소를 파라미터라고 부르겠습니다. 
	
	// input 요소의 name 속성값을 문자열 인자로 합니다.
...
<!-- jsp는 서버측에서 컴파일 되고 실행ㅇ ㅣ됩니다
	-> 컴파일 후에는 .java 파일로 변경되고
	-> .java 를 컴파일 해서 .class 를 생성합니다.
	-> 웹페이지를 요청한 클라이언트에게는 .class 파일로 html 문서를 작성하여 응답합니다.
	
 -->
 <!--  이클립스는 jsp 에대한 소스파일이 여기에 있습니다. 
